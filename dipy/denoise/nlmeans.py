...
def nlmeans4D(arr, sigma, mask=None, patch_radius=1, block_radius=5, rician=False):
    """ Non-local means for denoising 3D and 4D images
    ...
    """
    return nlmeans_4d(arr, mask, sigma, patch_radius, block_radius, rician).astype(arr.dtype)
